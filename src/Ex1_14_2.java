...
mainメソッドの内容は書き換えずに処理が通るようなメソッドを仕様に従って書く。
----------------------------------------------------*/
public class Ex1_14_2 {
	...
	/*
	**以下の仕様を持つメソッドcalcTaxPaymentを作成。
	**  - 引数として受け取った値の税込価格（消費税は8％とする）を計算して返す
	**  - 税込価格は整数（小数点以下切り捨て）で返す
	*/
	static int calcTaxPayment( ){        //アンダーバーを適切な内容に書き換える
	...
	**  - 割引金額の上限は5000円とする
	*/
	static int discount(){            //アンダーバーを適切な内容に書き換える
