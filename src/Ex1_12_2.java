/*-< 演習：Ex1_12_2 >---------------------------------
以下は以前に講座で扱った Sample1_11_1.java と同じ内容の処理。
このプログラムは 0 や 1 などをコマンドライン引数で受け取ると無限ループに陥ってしまう。
この対策としてreceiveNumberが以下のNGパターンに該当する場合はwhile文を実行せず、代わりに
「適切な値を入力してください」というメッセージを表示するプログラムに書き換える。
	...
	public static void main (String[] args) {
		...
		*/
		...
		if(receiveNumber < 0 || receiveNumber == 0 || receiveNumber == 1) {
			System.out.println("適切な値を入力して下さい");
